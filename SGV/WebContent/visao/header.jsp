...
<html>
    ...
    <!--Custom Font-->
    <link rel="stylesheet" href="font/stylesheet.css" media="all" type="text/css">
...
<div class="row">
	...
	<header class="no-border col_16">
        ...
        <div class="logo float_right"><img src="images/svg-logo300.png" alt="Sistema de Gerenciamento de Vagas"></div>
